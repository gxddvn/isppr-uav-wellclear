...
- Підвищення безпеки BVLOS-польотів малих БАК

- Оптимізація траєкторій при потенційній загрозі зіткнення

- Мінімізація ризику Near Mid-Air Collision (NMAC)

- Підтримка моделювання корельованих та некорельованих зустрічей з іншими повітряними суднами

# Key Features / Ключові можливості

- Моделювання дій оператора БАК під час конфліктних ситуацій

- Інтеграція алгоритмів "Well Clear" для малих БАК (sUAS)

- Використання нейронних мереж та методів ШІ для прийняття рішень

- Симуляції та аналіз ризику для оптимального маршруту польоту
